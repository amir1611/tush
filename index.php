...
$file_action = "config-generator-do/";
$file_style = "style.css";
$file_js_script = "script.js";
$file_tabber = "tabber.js";
$file_sessvars = "sessvars.js";
...
<div class="tabber">
	...
	<p>
		<table border=1 style="border-color: white;border-style: none;">
			...
			Vendor:</td><td>
			<select name =vendor>
			  <option value="cisco_ios" <?php echo ($todo == "load") ? (($conf["vendor"] == "cisco_ios") ? "selected": ""): "selected"; ?> >Cisco (IOS)</option>
			  <option value="juniper_junos" <?php echo ($todo == "load") ? (($conf["vendor"] == "juniper_junos") ? "selected": ""): ""; ?> >Juniper (JunOS)</option>
			  <option value="nortel" <?php echo ($todo == "load") ? (($conf["vendor"] == "nortel") ? "selected": ""): ""; ?> >Nortel (small switches)</option>
			</select>
			</td></tr><tr align=left><td>

			Hostname:</td><td>
			<Input type="text" name=hostname value="<?php echo htmlspecialchars(($todo == "load") ? $conf["hostname"] : ""); ?>">
			</td></tr>
			<tr align=left><td>
			
			IP address: </td><td>
			<Input type="text" name=ip value="<?php echo htmlspecialchars(($todo == "load") ? $conf["ip"] : ""); ?>">
			</td></tr><tr align=left><td>

			Subnet Mask: </td><td>
			<Input type="text" name=subnetmask value="<?php echo htmlspecialchars(($todo == "load") ? $conf["subnetmask"] : "255.255.255.0"); ?>">
			</td></tr><tr align=left><td>

			Default Gateway: </td><td>
			<Input type="text" name=defaultgateway value="<?php echo htmlspecialchars(($todo == "load") ? $conf["defaultgateway"] : ""); ?>">
			</td></tr><tr align=left><td>

			Routing enabled: </td><td>
			<select name =routing_enabled>
			  <option value="no" <?php echo ($todo == "load") ? (($conf["routing_enabled"] == "no") ? "selected": ""): ""; ?>>No</option>
			  <option value="yes" <?php echo ($todo == "load") ? (($conf["routing_enabled"] == "yes") ? "selected": ""): "selected"; ?>>Yes</option>
			</td></tr><tr align=left><td>


			Managment Vlan:<br/>(for Nortel)</td><td>
			<Input type="text" name=mgmt_vlan value="<?php echo htmlspecialchars(($todo == "load") ? $conf["mgmt_vlan"] : "1"); ?>">
			</td></tr><tr align=left><td>
			
			stack: </td><td>
			<select name =stack>
			  <option value="no" <?php echo ($todo == "load") ? (($conf["stack"] == "no") ? "selected": ""): "selected"; ?>>No</option>
			  <option value="yes" <?php echo ($todo == "load") ? (($conf["stack"] == "yes") ? "selected": ""): ""; ?>>Yes</option>
			</select>
			</td></tr>
		</table>
	</p>
	...
	<p>
		...
		<b>Configure Ports</b>: 
			<select name =configure_Ports>
			  <option value="no" <?php echo ($todo == "load") ? (($conf["configure_Ports"] == "no") ? "selected": ""): ""; ?>>No</option>
			  <option value="yes" <?php echo ($todo == "load") ? (($conf["configure_Ports"] == "yes") ? "selected": ""): "selected"; ?>>Yes</option>
			</select><br/>
	...
	<p>
		...
		<table>
			...
			<select name =stp_mode>
			  <option value="stp" <?php echo ($todo == "load") ? (($conf["stp_mode"] == "stp") ? "selected": ""): "selected"; ?> >STP</option>
			  <option value="rstp" <?php echo ($todo == "load") ? (($conf["stp_mode"] == "rstp") ? "selected": ""): ""; ?> >Rapid STP</option>
			</select>
			</td></tr>
			<tr align=left><td>
			
			Bridge priority: </td><td>
			<Input type="text" name=stp_Priority value="<?php echo htmlspecialchars(($todo == "load") ? $conf["stp_Priority"] : ""); ?>">
			</td></tr>
		</table><br/>
		<table>
			<tr align=left><td>
	...
	<p>
		...
		<b>Configure Vlans</b>: 
			<select name =configure_Vlans>
			  <option value="no" <?php echo ($todo == "load") ? (($conf["configure_Vlans"] == "no") ? "selected": ""): ""; ?>>No</option>
			  <option value="yes" <?php echo ($todo == "load") ? (($conf["configure_Vlans"] == "yes") ? "selected": ""): "selected"; ?>>Yes</option>
			</select><br/>
		<table class="xl">
	...
	<p>
		...
		<b>Configure VRRP/HSRP</b>: 
			<select name =configure_VRRP>
			  <option value="no" <?php echo ($todo == "load") ? (($conf["configure_VRRP"] == "no") ? "selected": ""): "selected"; ?>>No</option>
			  <option value="yes" <?php echo ($todo == "load") ? (($conf["configure_VRRP"] == "yes") ? "selected": ""): ""; ?>>Yes</option>
			</select><br/>
		<table class="xl">
